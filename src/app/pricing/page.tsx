  ...
  const tiers = [
      {
        ...
        features: [
          '5 copies offertes (une seule fois)',
      ...
      {
        name: 'Petit Correcteur',
        price: '5€',
        period: '/ mois',
        description: 'Pour les petites classes',
        features: [
          '50 copies / mois',
      ...
      },
      {
        ...
        price: '15€',
        period: '/ mois',
        description: 'Pour les profs au quotidien',
        features: [
          '500 copies / mois',
          'Export SACoche + Pronote',
          'Barème photo (OCR)',
      ...
      },
      {
        ...
        price: '99€',
        period: '/ an',
        description: 'Tout le Standard + 2 mois offerts',
        features: [
          '2 000 copies / mois',
          'Export SACoche + Pronote',
          'Barème photo (OCR)',
