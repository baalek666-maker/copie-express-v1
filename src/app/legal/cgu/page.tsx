    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto p-8">
        ...
        <ul>
          ...
          <li>Fonctionnalités : lecture des réponses, export CSV basique</li>
        </ul>
        ...
        <ul>
          ...
          <li>Fonctionnalités : lecture des réponses, export SACoche, export Pronote, support prioritaire</li>
        </ul>
        ...
        <p>L&apos;utilisateur conserve l&apos;entière propriété des copies qu&apos;il télécharge et des données qu&apos;il renseigne. Il concède à l&apos;éditeur une licence limitée au traitement technique nécessaire à la fourniture du service (lecture des copies, export).</p>
        ...
        <p>La lecture des copies peut comporter des erreurs. <strong>L&apos;utilisateur est seul responsable de la validation finale des notes.</strong> L&apos;éditeur ne saurait être tenu responsable en cas d&apos;erreur de lecture ayant des conséquences sur la notation des élèves.</p>
        <h3>9.3 Dommages</h3>
